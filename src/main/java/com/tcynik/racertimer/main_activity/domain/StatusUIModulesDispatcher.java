package com.tcynik.racertimer.main_activity.domain;
...
import com.tcynik.racertimer.main_activity.presentation.interfaces.LocationChanger;
...
public class StatusUIModulesDispatcher {
    private final static String PROJECT_LOG_TAG = "racer_timer_statusUI";
